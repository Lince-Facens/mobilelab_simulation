...
void PriusHybridPlugin::OnPriusCommand(const mobilelab_msgs::Control::ConstPtr &msg)
{
  ...
  {
    case mobilelab_msgs::Control::NEUTRAL:
      this->dataPtr->directionState = PriusHybridPluginPrivate::NEUTRAL;
      break;
    case mobilelab_msgs::Control::FORWARD:
      this->dataPtr->directionState = PriusHybridPluginPrivate::FORWARD;
      break;
    case mobilelab_msgs::Control::REVERSE:
...
void PriusHybridPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  this->dataPtr->controlSub = nh.subscribe("mobilelab", 10, &PriusHybridPlugin::OnPriusCommand, this);

  this->dataPtr->node.Subscribe("/mobilelab/reset",
      &PriusHybridPlugin::OnReset, this);
  this->dataPtr->node.Subscribe("/mobilelab/stop",
  ...
  this->dataPtr->consolePub =
    this->dataPtr->node.Advertise<ignition::msgs::Double_V>("/mobilelab/console");
